...
function add_jquery_script() {
    ...
    wp_register_script( 'coolkitty', get_stylesheet_directory_uri() . '/js/coolkitty.js' );
    wp_enqueue_script( 'coolkitty' );
}    
 ...
 */
function larryweber_widgets_init() {
 ...
 */
function larryweber_configure_dashboard_menu() {
        global $menu,$submenu;
...
if (!current_user_can('manage_options')) {
        ...
        add_action('admin_head', 'larryweber_configure_dashboard_menu'); // Add action to hide admin menu items
}
